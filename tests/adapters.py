...
def run_embedding(
    ...
    x = module.Embedding(vocab_size, d_model)
    state_dict = {
        "embeddings": weights
    }
    x.load_state_dict(state_dict)
    return x.forward(token_ids)
...
def run_swiglu(
    ...
    x = module.SwiGLU(d_model, d_ff)
    x.w2.weight.data = w2_weight
    x.glu.W1.weight.data = w1_weight
    x.glu.W2.weight.data = w3_weight
    return x.forward(in_features)
...
def run_multihead_self_attention(
    ...
    """
    x = module.MultiHeadSelfAttention(d_model, num_heads)
...
def run_rope(
    ...
    """
    x = module.RoPE(theta, d_k, max_seq_len)
    return x.forward(in_query_or_key, token_positions)
...
def run_get_batch(
    ...
    """
    return module.get_batch(dataset, batch_size, context_length, device)
...
def run_cross_entropy(
    ...
    return loss.forward(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    module.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return module.get_lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    module.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return module.load_checkpoint(src, model, optimizer)
